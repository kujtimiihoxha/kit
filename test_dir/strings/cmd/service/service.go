...
import (
	...
	http "github.com/kujtimiihoxha/kit/test_dir/strings/pkg/http"
...
var fs = flag.NewFlagSet("strings", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "strings")
